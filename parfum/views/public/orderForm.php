...
<div id="back" class="container mt-5" style=' background-image: url("./assets/images/back2.jpg");'>
  <div class="row">
      ...
      <div class="card mt-2">
        ...
        <div class="card-body">
          <form action="<?php $_SERVER['PHP_SELF']  ?>" method="post">
            ...
            <button type="submit" name="submit" class="mt-2 btn btn-dark col-12"><i class="far fa-check-square"></i> Envoyer</button>
          </form>
