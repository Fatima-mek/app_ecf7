<?php ob_start();?>
 ...
 <div class="container">
     <div class="row">
         ...
         <h1 class="display-6 text-center border border-5 border border-danger font-monospace m-5">Ajout d'un Parfum</h1>
             <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-dark  col-12 mt-5" name="soumis">Insérer</button>
            </form>
         </div>
     </div>
 </div>
