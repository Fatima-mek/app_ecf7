...
class PublicController{
    ...
    {
        $this->pubpm = new AdminParfumModel();
        $this->pubcm = new AdminCategorieModel();
        $this->pubm = new PublicModel();

    }

    public function getPubParfum(){
        ...
        if(isset($_GET['id']) && !empty($_GET['id'])){
            if( isset($_POST['soumis']) && !empty($_POST['search'])){
                ...
                $parfums = $this->pubpm->getParfum($search);
                ...
                $tabCat = $this->pubcm->getCategories();
                $parfums = $this->pubm->findParfByCat($p);
    ...
    public function payment(){
        ...
        // if(isset($_POST) && !empty($_POST['email']) && !empty($_POST['quantite'])){}
         \Stripe\Stripe::setApiKey('sk_test_51Id9IwHTOaWQqEWgCEFG2hxgh5h7hQa87nAxIcyFMm12upB7yq1RknewxNlUtZai4zUF9hQLLGWBhZfjGtKnxEcQ00YXvcVKcd');
         ...
         'mode' => 'payment',
         'success_url' => 'http://localhost/php/app_ecf7/parfum/index.php?action=success',
         'cancel_url' => 'http://localhost/php/app_ecf7/parfum/index.php?action=cancel',
         ]);
         $_SESSION['pay'] = $_POST;
     ...
     public function confirmation() {
         ...
         if($nbLine > 0 ){
             ...
             try {
                 ...
                 //Recipients
                 $mail->setFrom('dwwm94@gmail.com', 'BESTPERFUMES');
